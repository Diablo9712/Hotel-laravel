		...
		<div class="container">
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					...
					<li class="menu__item">   <a  class="menu__link scroll" href=""> {{ Auth::user()->fullname }}</a></li>
                    @else
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="{{ route('find_rooms.index') }}"><h2>ROOM RESERVATION</h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MIR AGE </span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+212 6-15-17-51-74</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:reda19burn1997@gmail.com">REDA19BURN1997@GMAIL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> QUARTIER ADARISSA RUE 1 N°91 BENI MELLAL, MOROCCO</p>
